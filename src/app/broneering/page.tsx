...
export default async function BookingPage(){
  try{const tenant=await tenantForHost((await headers()).get('host')??'');return <ManageBooking company={{name:tenant.name,address:tenant.address,email:tenant.contact_email,phone:tenant.contact_phone}}/>;}
