...
| 04 | Kasutajad, ettevõtted ja õigused | Tegemata | Puuduvad kasutajad, liikmesused, rollid, sessioonid, kutsed, MFA ja kontode sulgemine. Avalik töötajaprofiil ei ole sisselogimiskonto. |
| 05 | Domeenid ja kodulehele lisamine | Osaline | [tenants.ts](../src/lib/tenants.ts), [SERVER](SERVER.md): täpne hostiseos ja HTTPS olemasolevatel hostidel. Uute ettevõtete automaatne HTTPS, lubatud kodulehtede register, iframe ja modaal puuduvad. |
...
| Veebilehele lisamine | Tavaline link olemas | Lubatud päritolud, iframe, modaal ja varulink (05) |
...
Peatükkide 01–03 ulatus ja otsused seotakse töödega, jätmata nende avatud küsimusi peitu. Sisukorras esimene terviklikult puuduv tehniline alus on **04: kasutajad, ettevõtted ja õigused**. Enne selle koodi tuleb kirjeldada rollimaatriksist lähtuvad toimingud, kasutaja/liikmesuse andmed, autentimine, kutsete ja sessioonide elutsükkel ning AT-19, AT-23 ja AT-24 seosed. Halduskalendrit ega teenuste muutmise nuppe ei loeta valmis enne serveripoolseid õigusi. Omaniku erandeid ei mõelda välja; tavapärane teostus jätkub kinnitatud ulatuses.

## Tõendite piir

Praegu on 12 broneerimismootori testi ja 4 otsingunähtavuse testi. **16 läbivat testi ei tähenda 48 dokumendi vastuvõtutesti läbimist.** Brauseris kinnitatud proovibroneering tõendab konkreetset põhivoogu. Varasemate kontrollide ulatus on failis [VALIDATION.md](VALIDATION.md); käesoleva dokumentatsiooniparanduse ajal neid uuesti ei käivitatud ega uusi funktsioone serverisse lisatud.
