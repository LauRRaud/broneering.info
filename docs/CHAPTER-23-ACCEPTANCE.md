...
**Kooskõlastus 12.09.2026:** käitamise read on täpsustatud peatüki 26 värskete tõenditega. [Allesjäänud tööde ja otsuste register](REMAINING-WORK.md) eristab tehnilist läbimist, väliseid sõltuvusi ja omaniku vastuvõttu; registri uuendamisel katseid uuesti ei käivitatud.
...
| AT-39 CSV-impordi kordus ja vead | Serveri HTTP tehniline katse läbitud 12.09 | [Ptk 26](CHAPTER-26.md): kliendi-/broneeringu-CSV üleslaadimine, vigane rida/päis, selge vahelejätmine, korduskinnitus ja korduv väline ID; kõik neli impordiliiki värskes integratsioonikatses. F-05 Nginxi parandus paigaldatud 08.09 | Kõigi impordivormide sõltumatu kasutajavastuvõtt G03; SMTP kontroll G05 |
| AT-40 Import või testrežiim | Tehniline ja serveri DB-tõend | [Ptk 26](CHAPTER-26.md): päris HTTP import säilitas `customer_notifications=false`, outbox ei kasvanud; impordi/testrežiimi teavituste katsed läbivad | Päris SMTP-ga sünteetiliste adressaatide kontroll G05 |
| AT-41 Sama kuu arveldustöö kordus | Sisemise arvelduse serverikatse läbitud 12.09 | [Ptk 26](CHAPTER-26.md): paralleelsed ja korduvad käivitused lõid ühe 35 € arve iga kolme kuu kohta; värske integratsiooniregressioon | Maksekeskuse/SMTP välisühenduste vastuvõtt G05 |
| AT-42 Makse märkimine ja tähtaja ületamine | Sisemise arvelduse tehniline tõend | [Ptk 26](CHAPTER-26.md): sünteetilised maksekanded korduskindlad; tähtaja otsus teenusefunktsioonile antud kuupäeval, tasumise järel ligipääs lubatud; maksete regressioon läbiv | Päris Maksekeskuse tehingud, nõusolek, lepitus/tagastused ning SMTP vastuvõtt G05 |
| AT-43 Varukoopiast taastamine | Sama VPS-i täielik tehniline katse läbitud 12.09 | [Ptk 26](CHAPTER-26.md): 53 tabeli täielike ridade räsivõrdlus, privaatfailid, uuem eemaldamisregister, vanade seansside/eksportide tühistamine ja taastatud rakenduse HTTP; 11,9 s | Uue hosti serverikao taastamine, väline varundusgraafik/võtmed ning WAL/RPO/RTO G08; sama VPS-i tulemus neid ei tõenda |
...
| AT-46 Ettevõtte lahkumine | Serveri HTTP ja tegeliku kella tehniline katse läbitud 12.09 | [Ptk 26](CHAPTER-26.md): uute broneeringute sulgemine, lubatud eksport/allalaadimine, tähtajal kalendri ja ekspordiõiguste lõpp; 1024 broneeringut ja domeenireservatsioon säilisid | Kinnitatud päris andmeleping, säilitustähtajad ja automaatika G07; väliste koopiate korraldus G08 |
