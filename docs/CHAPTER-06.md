...
Kõik 59 rakenduse testi, tüübikontroll ning kohalik tootmisbuild läbisid. Nende hulgas on kümme uut andmebaasitesti: pärimine/erisused, õigused/MFA, RLS ja ettevõttepiirid, vigased väärtused, paralleelsed versioonid, ajalugu, aegunud pakkumine, arhiveerimine ja avaliku profiili andmepiir. Lisaks läbisid kaks hierarhiatesti: eri harude samanimelised grupid, ülemgrupi arhiveerimine, tsüklikeeld, võõras ülemgrupp ning grupipuu RLS. 07.09.2026 avaldati commit f51fd68 ja migratsioonid 005/006. Enne muudatusi loodi serveris backups/before-chapter06.dump; faili õigused on 600. SSH väljund katkes, kuid eraldi kontroll kinnitas mõlemad migratsioonid, uuendatud töötava veebikonteineri ja haldusmarsruudi. HTTPS avaleht näitas uut teenusepakkujate sõnastust; demo kataloog säilitas kõik neli varasemat hinda/kestust ning anonüümne halduse API tagastas ainult sisselogimata seisundi.
